    ...
    fetch(apiUrl)
        ...
        .then((data) => {
            ...
            let cityContent = `
                        ...
                        <div class="pointColor" style="--pointColor:${pointColor}; --tempval:${
                Math.round(temp) + 5
            };">
                        </div>
                        <div class="degs">
                        ...
                        <div class="circleOfInfo">
                            ...
                            <div class="min-max-temp">
                                <span class="minTemp">Min :${Math.floor(
                                    temp_min
                                )}</span>
                                <span class="maxTemp">Max : ${Math.ceil(
                                    temp_max
                                )}</span>
                            </div>
                        ...
                        <div class="weather-winnd">
                            ...
                            <div class="wind">
                                ...
                                <span class="windSpeed">speed: ${Math.round(
                                    speed
                                )} <span>km/h</span></span>
        ...
        .catch(() => {
            showInvalidCity.style.display = "block";
        });
}
...
if (
    ...
    if (time < 18 && time > 7) {
        body.style.background =
            "url(/images/after_noon.webp) center/cover no-repeat fixed";
        input.style.color = "black";
        input.style.borderColor = "black";
    } else {
        body.style.background =
            "url(/images/night.webp) center/cover no-repeat fixed";
    }
